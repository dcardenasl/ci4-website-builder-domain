...
class SiteLegalPagesSeederChile extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->upsertPageTranslation($legalNoticeId, $langIds['es'], [
            ...
            'meta_title'       => 'Aviso Legal | [TU_NOMBRE_EMPRESA]',
        ...
        $this->upsertPageTranslation($legalNoticeId, $langIds['en'], [
            ...
            'meta_title'       => 'Legal Notice | [YOUR_COMPANY_NAME]',
        ...
        $this->upsertBlock($legalNoticeId, $blockIds, 'rich_text', 2, [], [
            'es' => ['content' => '<h2>1. Datos Identificativos</h2><p>En cumplimiento con la Ley 19.628 sobre Protección de Datos de Carácter Personal, se proporciona la siguiente información:</p><ul><li><strong>Nombre o Razón Social:</strong> [TU_NOMBRE_EMPRESA]</li><li><strong>RUT:</strong> [TU_RUT]</li><li><strong>Domicilio:</strong> [TU_DIRECCIÓN_COMPLETA], [TU_REGIÓN_CHILE]</li><li><strong>Teléfono:</strong> [TU_TELÉFONO]</li><li><strong>Email Contacto:</strong> [TU_EMAIL_CONTACTO]</li><li><strong>Giro Comercial:</strong> [TU_GIRO_COMERCIAL]</li></ul><h2>2. Aceptación de Términos</h2><p>El acceso y uso de este sitio web implica la aceptación íntegra de los términos y condiciones aquí establecidos. Si no está de acuerdo, debe abstenerse de usar este sitio.</p><h2>3. Propiedad Intelectual</h2><p>Todos los contenidos del sitio (textos, imágenes, diseños, logos, software) son propiedad intelectual de [TU_NOMBRE_EMPRESA] o sus licenciantes, protegidos por la Ley 17.336 sobre Derechos de Autor. Queda prohibida su reproducción sin autorización.</p><h2>4. Limitación de Responsabilidad</h2><p>El sitio se proporciona "tal cual" sin garantías. [TU_NOMBRE_EMPRESA] no es responsable de daños derivados de su uso, interrupciones, errores técnicos o acceso no autorizado.</p><h2>5. Ley Aplicable</h2><p>Este aviso se rige por las leyes de la República de Chile. Cualquier controversia será resuelta por los juzgados competentes de [TU_CIUDAD_CHILE].</p>'],
            'en' => ['content' => '<h2>1. Identifying Information</h2><p>In compliance with USA regulations, the following information is provided:</p><ul><li><strong>Company Name:</strong> [YOUR_COMPANY_NAME]</li><li><strong>Street Address:</strong> [YOUR_STREET_ADDRESS]</li><li><strong>City, State, ZIP:</strong> [YOUR_CITY], [YOUR_STATE] [YOUR_ZIP]</li><li><strong>Phone Number:</strong> [YOUR_PHONE_NUMBER]</li><li><strong>Business Type:</strong> [YOUR_BUSINESS_TYPE]</li></ul><h2>2. Acceptance of Terms</h2><p>Access to and use of this website implies full acceptance of the terms and conditions established here. If you do not agree, you must refrain from using this site.</p><h2>3. Intellectual Property</h2><p>All site content (texts, images, designs, logos, software) is intellectual property of [YOUR_COMPANY_NAME] or its licensors, protected by US copyright law. Reproduction without authorization is prohibited.</p><h2>4. Limitation of Liability</h2><p>The site is provided "as is" without warranties. [YOUR_COMPANY_NAME] is not responsible for damages arising from its use, interruptions, technical errors, or unauthorized access.</p><h2>5. Applicable Law</h2><p>This notice is governed by the laws of the United States. Jurisdiction: courts of [YOUR_STATE].</p>']
        ], $langIds);
        ...
        $this->upsertPageTranslation($privacyId, $langIds['es'], [
            ...
            'meta_title'       => 'Política de Privacidad | [TU_NOMBRE_EMPRESA]',
        ...
        $this->upsertPageTranslation($privacyId, $langIds['en'], [
            ...
            'meta_title'       => 'Privacy Policy | [YOUR_COMPANY_NAME]',
        ...
        $this->upsertBlock($privacyId, $blockIds, 'rich_text', 3, [], [
            'es' => ['content' => '<div id="responsable" class="scroll-mt-20"><h2>1. Responsable del Tratamiento</h2><p>El responsable de tus datos es [TU_NOMBRE_EMPRESA], RUT [TU_RUT], ubicado en [TU_DIRECCIÓN_COMPLETA]. Contacto: [TU_EMAIL_PRIVACIDAD]</p></div><div id="datos" class="scroll-mt-20"><h2>2. Datos Personales que Recopilamos</h2><p>Recopilamos datos que proporcionas voluntariamente:</p><ul><li>Nombre completo</li><li>Correo electrónico</li><li>Teléfono (opcional)</li><li>Datos de formularios</li><li>Información de navegación (IP, navegador, páginas visitadas)</li></ul></div><div id="finalidad" class="scroll-mt-20"><h2>3. Para Qué Usamos Tus Datos</h2><ul><li>Responder consultas y solicitudes</li><li>Enviar información solicitada</li><li>Mejorar el sitio web</li><li>Cumplir obligaciones legales</li><li>Comunicaciones sobre cambios en políticas</li></ul></div><div id="derechos" class="scroll-mt-20"><h2>4. Tus Derechos (Ley 19.628)</h2><p>Tienes derecho a:</p><ul><li><strong>Acceso:</strong> Conocer qué datos tenemos sobre ti</li><li><strong>Rectificación:</strong> Corregir datos inexactos</li><li><strong>Cancelación:</strong> Solicitar eliminación de tus datos</li><li><strong>Oposición:</strong> Oponerté al uso de tus datos</li></ul><p>Plazo de respuesta: 15 días hábiles. Contacta a [TU_EMAIL_PRIVACIDAD]</p></div><div id="seguridad" class="scroll-mt-20"><h2>5. Seguridad de Tus Datos</h2><p>Implementamos medidas de seguridad:</p><ul><li>Encriptación SSL/TLS</li><li>Acceso restringido a personal autorizado</li><li>Auditorías de seguridad regulares</li><li>Protección contra acceso no autorizado</li></ul><p><strong>Última actualización:</strong> ' . date('d/m/Y') . '</p></div>'],
            'en' => ['content' => '<div id="collect" class="scroll-mt-20"><h2>1. Information We Collect</h2><p>We collect information you voluntarily provide through contact forms and website interactions:</p><ul><li>Full name</li><li>Email address</li><li>Phone number (optional)</li><li>Form submission data</li><li>Navigation information (IP address, browser type, pages visited)</li></ul></div><div id="use" class="scroll-mt-20"><h2>2. How We Use Your Information</h2><ul><li>Respond to your inquiries and requests</li><li>Send requested information</li><li>Improve the website</li><li>Comply with legal obligations</li><li>Communicate about policy changes</li></ul></div><div id="rights" class="scroll-mt-20"><h2>3. Your Rights & Choices (CCPA)</h2><p>Under the California Consumer Privacy Act, you have the right to:</p><ul><li><strong>Know:</strong> What personal information we collect and how we use it</li><li><strong>Delete:</strong> Request deletion of your personal information</li><li><strong>Opt-Out:</strong> Opt out of the sale or sharing of personal information</li><li><strong>Non-Discrimination:</strong> We will not discriminate against you for exercising your privacy rights</li></ul><p>Response time: 45 days. Contact us at [YOUR_PRIVACY_EMAIL]</p></div><div id="security" class="scroll-mt-20"><h2>4. Security</h2><p>We implement security measures to protect your data:</p><ul><li>SSL/TLS encryption</li><li>Restricted access to authorized personnel only</li><li>Regular security audits</li><li>Protection against unauthorized access</li></ul><p><strong>Last updated:</strong> ' . date('m/d/Y') . '</p></div><div id="contact" class="scroll-mt-20"><h2>5. Contact Us</h2><p>For privacy concerns or to exercise your rights, contact us at [YOUR_PRIVACY_EMAIL]</p></div>']
        ], $langIds);
        ...
        $this->upsertPageTranslation($cookiesId, $langIds['es'], [
            ...
            'meta_title'       => 'Política de Cookies | [TU_NOMBRE_EMPRESA]',
        ...
        $this->upsertPageTranslation($cookiesId, $langIds['en'], [
            ...
            'meta_title'       => 'Cookie Policy | [YOUR_COMPANY_NAME]',
        ...
        $this->upsertPageTranslation($termsId, $langIds['es'], [
            ...
            'meta_title'       => 'Términos de Servicio | [TU_NOMBRE_EMPRESA]',
        ...
        $this->upsertPageTranslation($termsId, $langIds['en'], [
            ...
            'meta_title'       => 'Terms of Service | [YOUR_COMPANY_NAME]',
        ...
        $this->upsertPageTranslation($dataRightsId, $langIds['es'], [
            ...
            'meta_title'       => 'Tus Derechos sobre Datos | [TU_NOMBRE_EMPRESA]',
        ...
        $this->upsertPageTranslation($dataRightsId, $langIds['en'], [
            ...
            'meta_title'       => 'Your Data Rights | [YOUR_COMPANY_NAME]',
        ...
        $this->upsertPageTranslation($transparencyId, $langIds['es'], [
            ...
            'meta_title'       => 'Transparencia | [TU_NOMBRE_EMPRESA]',
        ...
        $this->upsertPageTranslation($transparencyId, $langIds['en'], [
            ...
            'meta_title'       => 'Transparency | [YOUR_COMPANY_NAME]',
        ...
        $this->upsertPageTranslation($accessibilityId, $langIds['es'], [
            ...
            'meta_title'       => 'Accesibilidad Web | [TU_NOMBRE_EMPRESA]',
        ...
        $this->upsertPageTranslation($accessibilityId, $langIds['en'], [
            ...
            'meta_title'       => 'Web Accessibility | [YOUR_COMPANY_NAME]',
