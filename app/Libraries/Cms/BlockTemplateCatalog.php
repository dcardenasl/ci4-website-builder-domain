    ...
    public static function all(): array
    {
        return [
            ...
            [
                ...
                'description' => 'Sección de cartelera con tarjetas de eventos. Carga entradas dinámicamente desde una colección del CMS.',
                'category'    => 'content',
                'icon'        => 'calendar-days',
                'default_schema' => [
                    'fields' => [
            ...
            [
                ...
                'default_schema' => [
                    'fields' => [
                        'section_title'  => ['type' => 'string', 'label' => 'Título de sección',  'required' => false],
                        'view_all_label' => ['type' => 'string', 'label' => 'Texto "Ver todas"',  'required' => false],
