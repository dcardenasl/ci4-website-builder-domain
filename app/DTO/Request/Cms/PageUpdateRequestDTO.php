...
readonly class PageUpdateRequestDTO extends BaseRequestDTO
{
    ...
    #[OA\Property(description: 'page_type', type: 'string', nullable: true, enum: ['home', 'generic', 'contact', 'privacy', 'terms', '404', '500', 'maintenance', 'about', 'history', 'events', 'components', 'media', 'collection_index', 'portfolio'])]
    ...
    /**
     * @var array<array{language_id: int, slug: string, title: string, excerpt?: string, meta_title?: string, meta_description?: string, og_image_file_id?: int, og_type?: string, canonical_url?: string, robots?: string, schema_data?: array<mixed>}>|null
     */
