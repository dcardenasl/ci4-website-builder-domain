...
readonly class EntryCreateRequestDTO extends BaseRequestDTO
{
    ...
    /**
     * @var array<array{language_id: int, slug: string, title: string, excerpt?: string, featured_file_id?: int, meta_title?: string, meta_description?: string, og_image_file_id?: int, og_type?: string, canonical_url?: string, robots?: string, schema_data?: array<mixed>}>
     */
